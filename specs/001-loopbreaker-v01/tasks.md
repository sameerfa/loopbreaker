...
- [x] T020 [US1] Implement **minimal UI** **`Source/PluginEditor.cpp/.h`** — Analyze/Stop, **8 | 16 | 32 bars** selector, status label, staticness numeric, concise summary block (energy / LM–H / transient / stereo), **three suggestion lines/cards**, timer-copy snapshot (**constitution §VI**); include **≤140 words** onboarding / help (**read-only** control acceptable) fulfilling **spec SC‑001**.
